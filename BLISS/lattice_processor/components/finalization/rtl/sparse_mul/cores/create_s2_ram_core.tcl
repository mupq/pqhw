...
set result [ run_cg_create "xilinx.com:ip:dist_mem_gen:7.2" "s2_ram_core" "Distributed Memory Generator" "Distributed Memory Generator (xilinx.com:ip:dist_mem_gen:7.2) generated by Project Navigator" xc6slx16-2csg324 VHDL ]
