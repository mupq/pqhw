...
HD_PWD=C:/Users/Toder/Documents/HardwareProjects/NewHope/NewHope.runs/invpsi_mem_synth_1
cd "$HD_PWD"
...
EAStep vivado -log invpsi_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source invpsi_mem.tcl
