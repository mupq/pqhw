...
HD_PWD=C:/Users/Toder/Documents/HardwareProjects/NewHope/NewHope.runs/xbip_dsp48_macro_0_synth_1
cd "$HD_PWD"
...
EAStep vivado -log xbip_dsp48_macro_0.vds -m64 -mode batch -messageDb vivado.pb -notrace -source xbip_dsp48_macro_0.tcl
