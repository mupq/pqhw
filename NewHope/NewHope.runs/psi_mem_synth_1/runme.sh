...
HD_PWD=C:/Users/Toder/Documents/HardwareProjects/NewHope/NewHope.runs/psi_mem_synth_1
cd "$HD_PWD"
...
EAStep vivado -log psi_mem.vds -m64 -mode batch -messageDb vivado.pb -notrace -source psi_mem.tcl
